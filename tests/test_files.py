...
def test_prune_and_ensure_removes_stale_and_downloads_missing(tmp_path):
    ...
    manifest = {
        "firmwares": [
            {"filename": FILENAME, "url": URL, "sha256": sha256_bytes(b"current")},
            {
                "filename": "bar_bootloader_2.0.gbl",
                "url": "https://github.com/o/r/releases/download/t/bar_bootloader_2.0.gbl",
    ...
    assert downloaded == [manifest["firmwares"][1]["url"]]
